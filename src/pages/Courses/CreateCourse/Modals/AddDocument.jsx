...
export const AddDocument = ({ isOpen, toggle }) => {
        ...
        <ModalBody >
            <div className="align-items-center d-flex flex-column">
                ...
                <div className="mt-4 align-items-center d-flex flex-column">
                    <h5>Upload Documents(s)</h5>
                    <p className="text-muted mb-0">You can upload upto 20 files at a time. Maximum file size that can be attached is 40 MB.</p>
                </div>
                <label htmlFor="video-upload">
                    <Button color="secondary" className="rounded-pill" onClick={() => document.getElementById('documents-upload')?.click()}> Select File(s) </Button>
                </label>
                <input
                    id="documents-upload"
                    type="file"
